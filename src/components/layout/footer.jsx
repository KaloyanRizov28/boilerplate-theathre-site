        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="flex flex-col gap-1">
            <Link href="/privacy-policy" className={linkStyle}>
              <span className="group-hover:text-[#27AAE1]">Политика за поверителност</span>
              <Arrow className={arrowStyle} />
            </Link>
            <Link href="/cookie-policy" className={linkStyle}>
              <span className="group-hover:text-[#27AAE1]">Политика за бисквитки</span>
              <Arrow className={arrowStyle} />
            </Link>
            <Link href="/terms" className={linkStyle}>
              <span className="group-hover:text-[#27AAE1]">Общи условия</span>
              <Arrow className={arrowStyle} />
            </Link>
          </div>
          ...
          <div className="flex flex-col items-end gap-4">
            ...
            <div className="w-14 h-14 relative flex-shrink-0 group">
              <Image
                src="/logo.svg"
                alt="МДТ Лого"
                fill
